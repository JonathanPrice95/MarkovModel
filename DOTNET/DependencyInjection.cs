...
namespace Sabio.Web.StartUp
{
    public class DependencyInjection
    {
        public static void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddSingleton<IBeersService, BeersService>();

            services.AddSingleton<IBeerModelsService, BeerModelsService>();
            ...
            services.AddSingleton<ICodingChallengesService, CodingChallengesService>();
        }
